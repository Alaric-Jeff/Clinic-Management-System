...
import { getThisDayPatients } from '../../services/search-engine-services/get-this-day-patients.js';
export async function searchPatientDayController(
  ...
  try {
    ...
    const result = await getThisDayPatients(request.server, params);
