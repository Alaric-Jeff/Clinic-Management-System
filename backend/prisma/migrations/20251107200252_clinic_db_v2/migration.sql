...
-- CreateEnum
CREATE TYPE "public"."ConsultationType" AS ENUM ('first', 'follow_up');

-- CreateEnum
CREATE TYPE "public"."Gender" AS ENUM ('male', 'female');

-- CreateEnum
CREATE TYPE "public"."ServiceCategory" AS ENUM ('hematology', 'bacteriology', 'clinical_microscopy', 'twenty_four_hour_urine_test', 'serology_immunology', 'clinical_chemistry', 'electrolytes', 'vaccine', 'histopathology', 'to_be_read_by_pathologist', 'tumor_markers', 'thyroid_function_test', 'hormones', 'hepatitis', 'enzymes', 'consultation', 'others');
...
CREATE TABLE "public"."medical_bills" (
    ...
    "isSeniorPwdDiscountApplied" BOOLEAN NOT NULL DEFAULT false,
    "discountRate" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "consultationFee" DOUBLE PRECISION NOT NULL DEFAULT 250,
...
-- CreateTable
CREATE TABLE "public"."bill_audit_logs" (
    "id" TEXT NOT NULL,
    "medicalBillId" TEXT NOT NULL,
    "action" TEXT NOT NULL,
    "fieldsChanged" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."billed_service_audit_logs" (
    "id" TEXT NOT NULL,
    "billedServiceId" TEXT NOT NULL,
    "medicalBillId" TEXT NOT NULL,
    "action" TEXT NOT NULL,
    "fieldsChanged" TEXT NOT NULL,
    "previousData" TEXT,
    ...
    CONSTRAINT "billed_service_audit_logs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "patients_registeredAt_idx" ON "public"."patients"("registeredAt");
...
-- CreateIndex
CREATE INDEX "bill_audit_logs_medicalBillId_idx" ON "public"."bill_audit_logs"("medicalBillId");

-- CreateIndex
CREATE INDEX "bill_audit_logs_createdAt_idx" ON "public"."bill_audit_logs"("createdAt");

-- CreateIndex
CREATE INDEX "billed_service_audit_logs_billedServiceId_idx" ON "public"."billed_service_audit_logs"("billedServiceId");

-- CreateIndex
CREATE INDEX "billed_service_audit_logs_medicalBillId_idx" ON "public"."billed_service_audit_logs"("medicalBillId");

-- CreateIndex
CREATE INDEX "billed_service_audit_logs_createdAt_idx" ON "public"."billed_service_audit_logs"("createdAt");

-- CreateIndex
CREATE INDEX "patient_audit_logs_patientId_idx" ON "public"."patient_audit_logs"("patientId");

-- CreateIndex
CREATE INDEX "patient_audit_logs_createdAt_idx" ON "public"."patient_audit_logs"("createdAt");
...
-- AddForeignKey
ALTER TABLE "public"."bill_audit_logs" ADD CONSTRAINT "bill_audit_logs_medicalBillId_fkey" FOREIGN KEY ("medicalBillId") REFERENCES "public"."medical_bills"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."billed_service_audit_logs" ADD CONSTRAINT "billed_service_audit_logs_billedServiceId_fkey" FOREIGN KEY ("billedServiceId") REFERENCES "public"."billed_services"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."billed_service_audit_logs" ADD CONSTRAINT "billed_service_audit_logs_medicalBillId_fkey" FOREIGN KEY ("medicalBillId") REFERENCES "public"."medical_bills"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."patient_audit_logs" ADD CONSTRAINT "patient_audit_logs_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "public"."patients"("id") ON DELETE CASCADE ON UPDATE CASCADE;
